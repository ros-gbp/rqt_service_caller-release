## rqt_service_caller (noetic) - 0.4.12-1

The packages in the `rqt_service_caller` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic rqt_service_caller` on `Sat, 26 Apr 2025 22:29:14 -0000`
...
## rqt_service_caller (noetic) - 0.4.11-1
